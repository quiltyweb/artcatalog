...
export const MOCKED_LAYOUT_GLOBAL_DATA = {
  ...
  allShopifyCollection: {
    nodes: [
      ...
      {
        id: "id-bloom-collection",
        title: "Bloom",
        handle: "bloom",
        description: "Bloom collection",
        descriptionHtml: "<p>Bloom collection</p>",
        image: null,
        products: [],
      },
      {
        id: "id-human-nature-collection",
        title: "Human Nature",
        handle: "human-nature",
        description: "Human Nature collection",
        descriptionHtml: "<p>Human Nature collection</p>",
        image: null,
        products: [],
      },
    ],
