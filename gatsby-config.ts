  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        ...
        url: `https://${process.env.GATSBY_SHOPIFY_STORE_DOMAIN}/admin/api/2026-01/graphql.json`,
        headers: {
    ...
    },
    {
      ...
      options: {
        ...
        url: `https://${process.env.GATSBY_SHOPIFY_STORE_DOMAIN}/api/2026-01/graphql.json`,
        headers: {
